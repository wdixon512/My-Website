  ...
  return (
    <Stack direction="column" gap="12" mt="12" align="center">
      ...
      <Text>
        ...
        solid foundation in computer science, having earned my bachelor's degree
        from Michigan State University in 2021. I believe in striking a
        harmonious balance between work and play, making the most of every
        opportunity that comes my way.
      </Text>
      <Text>
        While others may tread cautiously, I catapult headfirst into worthwhile
        adventures, daring to fail and willing to learn. In the pursuit of
        greatness, I relish challenges as stepping stones to growth and
        self-discovery. Along the way, laughter is my muse; with it, I seek to
        inspire others not to take life so seriously.
      </Text>
      <Text>
      ...
      <Text>
        ...
        achieving my goals. My computer science background has instilled in me a
        sense of discipline and dedication, enabling me to tackle challenges
